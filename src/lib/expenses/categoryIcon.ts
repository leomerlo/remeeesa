...
const CATEGORY_ICONS: Record<string, LucideIcon> = {
  ...
  compras: ShoppingBag,
  mascotas: PawPrint,
  // "Michis" is what this household actually calls the cats -- a paw print
  // is the generic pets glyph, a cat is the one they'd recognise.
  michis: Cat,
  michi: Cat,
  gatos: Cat,
  gato: Cat,
  ...
  afip: Landmark,
  arca: Landmark,
  monotributo: Landmark,
  patente: Landmark,
  impuesto: Landmark,
  impuestos: Landmark,
  municipal: Landmark,
  // Money owed, and the work-side categories this household tracks
  deudas: Banknote,
  deuda: Banknote,
  prestamo: Banknote,
  'herramientas digitales': Laptop,
  software: Laptop,
  publicidad: Megaphone,
  ads: Megaphone,
  'meta ads': Megaphone,
  'meta ads flor': Megaphone,
  // Car and health
  seguro: ShieldCheck,

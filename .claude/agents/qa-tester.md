...
- Write the missing tests yourself, following the repo's conventions (see AGENTS.md and existing tests): colocated test files, testing through public boundaries.
